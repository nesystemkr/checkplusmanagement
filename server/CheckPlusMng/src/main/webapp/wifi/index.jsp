...
startFuncs[startFuncs.length] = function() {
	...
	$gridLayout = initializeGrid({
			...
			colModel: [
					...
					{ name: 'serialNo'  , label: 'Serial No' , width: 200, align: 'center',},
					{ name: 'macAddress', label: 'MAC Addr'  , width: 200, align: 'center',},
					{ name: 'gateId'    , label: 'AP_GATE_ID', width: 120, align: 'center',},
					{ name: 'gatePw'    , label: 'AP_GATE_PW', width: 120, align: 'center',},
					{ name: 'wifiId'    , label: 'AP_WIFI_ID', width: 120, align: 'center',},
					{ name: 'wifiPw'    , label: 'AP_WIFI_PW', width: 120, align: 'center',},
