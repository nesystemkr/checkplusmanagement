...
startFuncs[startFuncs.length] = function() {
	...
	$gridLayout = initializeGrid({
			...
			colModel: [
					...
					{ name: 'brokerName'   , label: '판매업체', width: 300, align: 'center',},
					{ name: 'customerName' , label: '설치업체', width: 300, align: 'center',},
					{ name: 'contractDate' , label: '계약일'  , width: 120 , align: 'center', formatter: getGridDateFormatClosure()},
