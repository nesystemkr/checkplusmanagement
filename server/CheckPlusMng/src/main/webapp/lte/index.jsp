...
startFuncs[startFuncs.length] = function() {
	...
	$gridLayout = initializeGrid({
			...
			colModel: [
					...
					{ name: 'idString'  , label: '아이디'      , width: 120, align: 'center',},
					{ name: 'modelName' , label: '모델명'      , width: 120, align: 'center',},
					{ name: 'serialNo'  , label: '일련번호'    , width: 120, align: 'center',},
					{ name: 'usimNo'    , label: '유심일련번호', width: 120, align: 'center',},
					{ name: 'telephone' , label: '전화번호'    , width: 120, align: 'center',},
					{ name: 'gateId'    , label: 'LTE_GATE_ID' , width: 110, align: 'center',},
					{ name: 'gatePw'    , label: 'LTE_GATE_PW' , width: 110, align: 'center',},
					{ name: 'wifiId'    , label: 'LTE_WIFI_ID' , width: 110, align: 'center',},
					{ name: 'wifiPw'    , label: 'LTE_WIFI_PW' , width: 110, align: 'center',},
					...
					{ name: 'memo'      , label: '메모'        , width: 180, align: 'center',},
