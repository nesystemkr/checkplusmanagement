package kr.nesystem.appengine.common;
...
public class Constant {
	...
	static {
		...
		try {
			...
			FRAGMENT_CACHED = CommonFunc.getBooleanFromObject(prop.getProperty("FragmentCached"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	};
