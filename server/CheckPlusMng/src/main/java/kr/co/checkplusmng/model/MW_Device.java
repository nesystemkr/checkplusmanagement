...
public class MW_Device extends MW_IDBaseModel {
	...
	@Override
	public MW_Device fromEntity(Entity entity) {
		super.fromEntity(entity);
		setModelName(entity.getString("modelName"));
		setModelType(entity.getString("modelType"));
